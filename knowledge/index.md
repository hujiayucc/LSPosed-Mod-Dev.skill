...
本目录把原知识库的 49 个章节按主题拆分为轻量知识节点。默认按任务类型读取本目录文件；需要全文式审计时读取 `knowledge/index.md` 和 6 个主题分片。
...
| 写 Hook 代码 | `02-hook-api.md` + Java/Kotlin 模板；复杂场景加 `templates/defensive-error-handling.md` |
...
| Native Hook | `04-native-migration-helper.md` + `guides/advanced-combinations.md` + `cases/advanced-native-hook.md` |
...
| API 102 真实案例与模板规则 | `06-cases-templates.md` + `cases/api102-real-cases.md` + `cases/real-project-patterns.md` |
